package com.comtop.eimnote.cache;
...
public class DiskLruCacheUtil {
    ...
    private static int appVersion = getVersionCode();
    ...
    private static int getVersionCode() {
        return getVersionCode(NoteApp.getContext().getPackageName());
    }

    private static int getVersionCode(String packageName) {
        try {
            return NoteApp.getContext()
                    .getPackageManager()
