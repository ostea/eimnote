...
public class NotePagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = /*0xFF666666*/0xFFDA372A;
    ...
    private final int FIXEDWIDTH = DensityUtil.dip2px(NoteApp.getContext(), 30);

    public NotePagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public NotePagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NotePagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
...
//		tabTextSizeLarge = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,
// tabTextSizeLarge, dm);

        // get system attrs (android:textSize and android:textColor)

        setTabTyped(context, attrs);
        TypedArray a;
    ...
    private void setTabTyped(Context context, AttributeSet attrs) {
...
//                字体颜色不再变化
//                updateTextViewStyle(i, tabTextColor, tabTextSize);//初始化
            } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        indicatorOffset = (int) ((lineRight - lineLeft) / 2) - FIXEDWIDTH / 2;
...
//		canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height, rectPaint);
        canvas.drawRect(lineLeft + indicatorOffset, height - indicatorHeight, lineLeft +
                indicatorOffset + FIXEDWIDTH, height, rectPaint);
